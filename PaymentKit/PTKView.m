...
//    
//    backgroundImageView.image = [[UIImage imageNamed:@"textfield" inBundle:[NSBundle bundleForClass:[PTKView class]] compatibleWithTraitCollection:nil]
...
//    gradientImageView.image = [UIImage imageNamed:@"gradient" inBundle:[NSBundle bundleForClass:[PTKView class]] compatibleWithTraitCollection:nil];
...
- (void)setupPlaceholderView
{
    ...
    self.placeholderView.image = [UIImage imageNamed:@"placeholder"inBundle:[NSBundle bundleForClass:[PTKView class]] compatibleWithTraitCollection:nil];
...
- (void)setPlaceholderToCVC
{
    ...
    if (cardType == PTKCardTypeAmex) {
        [self setPlaceholderViewImage:[UIImage imageNamed:@"cvc-amex" inBundle:[NSBundle bundleForClass:[PTKView class]] compatibleWithTraitCollection:nil]];
    } else {
        [self setPlaceholderViewImage:[UIImage imageNamed:@"cvc" inBundle:[NSBundle bundleForClass:[PTKView class]] compatibleWithTraitCollection:nil]];
    }
}
...
- (void)setPlaceholderToCardType
{
    ...
    [self setPlaceholderViewImage:[UIImage imageNamed:cardTypeName inBundle:[NSBundle bundleForClass:[PTKView class]] compatibleWithTraitCollection:nil]];
}
